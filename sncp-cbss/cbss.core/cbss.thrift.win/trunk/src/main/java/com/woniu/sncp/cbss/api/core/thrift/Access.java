...
public class Access implements org.apache.thrift.TBase<Access, Access._Fields>, java.io.Serializable, Cloneable, Comparable<Access> {
  ...
  static {
    schemes.put(StandardScheme.class, new AccessStandardSchemeFactory());
    schemes.put(TupleScheme.class, new AccessTupleSchemeFactory());
  }
  ...
  public Access setType(long type) {
    this.type = type;
    setTypeIsSet(true);
    return this;
  }
  ...
  public Access setPasswd(String passwd) {
    this.passwd = passwd;
    return this;
  }
  ...
  public Access setOther(Map<String,String> other) {
    this.other = other;
    return this;
  }
  ...
  private static class AccessStandardSchemeFactory implements SchemeFactory {
    public AccessStandardScheme getScheme() {
      return new AccessStandardScheme();
    }
  }

  private static class AccessStandardScheme extends StandardScheme<Access> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Access struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.other = new HashMap<String,String>(2*_map0.size);
                String _key1;
                String _val2;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Access struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.other != null) {
        oprot.writeFieldBegin(OTHER_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter4 : struct.other.entrySet())
          {
  ...
  private static class AccessTupleSchemeFactory implements SchemeFactory {
    public AccessTupleScheme getScheme() {
      return new AccessTupleScheme();
    }
  }

  private static class AccessTupleScheme extends TupleScheme<Access> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, Access struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetOther()) {
        {
          ...
          for (Map.Entry<String, String> _iter5 : struct.other.entrySet())
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, Access struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other = new HashMap<String,String>(2*_map6.size);
          String _key7;
          String _val8;
