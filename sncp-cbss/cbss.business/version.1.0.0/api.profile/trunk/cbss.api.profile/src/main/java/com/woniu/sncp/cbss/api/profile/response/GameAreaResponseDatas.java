 ...
 */
public class GameAreaResponseDatas implements Serializable {
    ...
    public GameAreaResponseDatas(Long id,String name,Long gameId){
        this.id = id ;
        this.name = name;
        this.gameId = gameId;
    };
	...
	public GameAreaResponseDatas() {
	}

	public GameAreaResponseDatas(Long id, String name, Long gameId, Long subdbId, Long issuerId, String chargeType,
			String activeMode, String emigrateLimit, String isp, Date createDate, Date closeDate, String state,
			Long groupId, Long mergeId) {
		super();
		this.id = id;
		this.name = name;
		this.gameId = gameId;
