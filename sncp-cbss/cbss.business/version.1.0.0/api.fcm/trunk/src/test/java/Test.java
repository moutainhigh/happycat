	...
	public static void main(final String[] args) {
		try {
			...
			for (int i = 0; i < 100; i++) {
				...
				Data data = new Data(ApiConstants.VERSION, new ClientRequest(System.currentTimeMillis(), "1", "2", new HashMap<String, String>(0)), new Param(FcmConfRequestParam.class.getName(),
						ApiConstants.PARAM_RESOLVE_TYPE_DEFAULT, JSONObject.toJSONString(nciicRequestParam), new ArrayList<String>(0)), ApiConstants.TRACE_OPEN_CLIENT_STATE, "1");
				Signature signature = new Signature(0, "83FD67BBB5535E30E558B605747A8E7D");
