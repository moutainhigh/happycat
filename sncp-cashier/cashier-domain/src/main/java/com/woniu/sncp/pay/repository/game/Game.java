...
/**
 * 游戏类型定义表 - SN_GAME.GAME_TYPE
 * @author zhangweipeng, Wang Yuxing
 * @since 1.0
 */
@Entity
@Table(name = "GAME_TYPE", schema = "SN_GAME")
//@SequenceGenerator(name = "SEQ_GEN", sequenceName = "SN_GAME.GAME_TYPE_SQ")
//@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, include = "all")
public class Game implements SingleKeyPojo {
	
	private static final long serialVersionUID = 2282320534666624626L;
	/**
	 * 免费游戏
	 */
	...
	public Game(Long id, String gameName, String dynamicTableName, String currency, String chargeType, String activationMode) {
		this.id = id;
		this.name = gameName;
