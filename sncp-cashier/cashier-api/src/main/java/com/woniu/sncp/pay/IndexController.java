...
//    		}
    		...
    		if(PaymentConstant.PAYMENT_STATE_PAYED.equals(paymentOrder.getPaymentState())){
    			String result = paymentOrderService.createCallbackSyncTask(paymentOrder, payemntMerchnt, paymentOrder.getPayPlatformOrderId(), "174");
    			message = result;
