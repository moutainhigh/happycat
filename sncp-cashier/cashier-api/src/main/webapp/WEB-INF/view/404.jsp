    ...
    <body class="not_found_con">
    	  <div class="pay_header">
            <div class="logo_con">
                ...
                <img style="float: right;padding-top: 10px;" src="//uswww3.woniu.com/pay/images/customer_phone.png" />
            </div>
        </div>
        <div class="not_found">
            <img src="//uswww3.woniu.com/pay/images/404_img.jpg" />
            <p class="p1">404,无法完成支付。</p>
