package com.woniu.sncp.pay.core.service.payment.platform.tenpay.tools;
...
public class ClientResponseHandler {
	...
	*/
	...
	public boolean isTenpaySign() {
		...
		//算出摘要
		String sign = MD5Encrypt.encrypt(sb.toString(), this.charset).toLowerCase();
	...
	protected boolean isTenpaySign(String signParameterArray[]) {
		...
		//算出摘要
		String sign = MD5Encrypt.encrypt(
