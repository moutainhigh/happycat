 ...
 */
//@Service("rechargeSchedule")
public class RechargeSchedule implements Schedule{

	protected static final Logger LOGGER = LoggerFactory.getLogger(RechargeSchedule.class);
...
//	private BaseHibernateDAO<PassportQueue, Long> ppQueueTaskDao;
	...
	public PassportAsyncTask createSchedule(Map<String, Object> params) {
		...
		long sequence = sessionDao.findForLong("select sn_passport.pp_async_task_sq.nextval from dual");
